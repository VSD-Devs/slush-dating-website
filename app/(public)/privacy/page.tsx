...
export const metadata: Metadata = {
  title: 'Privacy Policy | Slush Dating - Your Data Protection Rights',
  description: 'Learn how Slush Dating protects your privacy and personal information. Read our comprehensive privacy policy covering data collection, usage, sharing, and your rights.',
  alternates: {
    canonical: 'https://slushdating.com/privacy'
  },
  openGraph: {
    title: 'Privacy Policy | Slush Dating - Your Data Protection Rights',
    description: 'Learn how Slush Dating protects your privacy and personal information. Read our comprehensive privacy policy.',
    url: 'https://slushdating.com/privacy',
  }
};
        ...
        {`
          {
            ...
            "@type": "WebPage",
            "name": "Privacy Policy",
            "description": "Slush Dating's privacy policy and data protection guidelines",
            "publisher": {
              "@type": "Organization",
              "name": "Slush Dating"
            },
        ...
        <main id="main-content" className="container mx-auto px-4 py-12 prose prose-lg max-w-none">
          <div className="max-w-5xl mx-auto">
            <article itemScope itemType="https://schema.org/Article">
              ...
              <div className="mb-12">
                <h2 className="text-2xl font-semibold mb-6" itemProp="about">This privacy notice describes how we might use your information if you:</h2>
              ...
              <div className="space-y-16">
                ...
                <section id="section-7" className="scroll-mt-16" itemProp="articleSection">
                ...
                <section id="section-8" className="scroll-mt-16" itemProp="articleSection">
                ...
                <section id="section-9" className="scroll-mt-16" itemProp="articleSection">
                ...
                <section id="section-10" className="scroll-mt-16" itemProp="articleSection">
                ...
                <section id="section-11" className="scroll-mt-16" itemProp="articleSection">
                ...
                <section id="section-12" className="scroll-mt-16" itemProp="articleSection">
                ...
                <section id="section-13" className="scroll-mt-16" itemProp="articleSection">
                ...
                <section id="section-14" className="scroll-mt-16" itemProp="articleSection">
                ...
                <section id="section-15" className="scroll-mt-16" itemProp="articleSection">
                ...
                <section id="section-16" className="scroll-mt-16" itemProp="articleSection">
